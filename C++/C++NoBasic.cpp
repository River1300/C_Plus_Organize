...
/*
< ÀÎÅÍÆäÀÌ½º > : ¼ø¼ö °¡»ó ÇÔ¼öµé¸¸ ¸ğ¿© ÀÖ´Â Ãß»ó Å¬·¡½º¸¦ Á¾Á¾ ´Ù¸¥ ¾ğ¾î³ª ½Ã½ºÅÛ¿¡¼­´Â ÀÎÅÍÆäÀÌ½º¶ó ºÎ¸¥´Ù.
	#. »çÀüÀû ÀÇ¹Ì·Î´Â ¼­·Î ´Ù¸¥ µÎ ½Ã½ºÅÛÀÇ Á¢Á¡ÀÌ¶ó´Â ¶æÀÌ´Ù.
	=> USB : ÄÄÇ»ÅÍÀÇ µ¥ÀÌÅÍ ÀÔÃâ·Â ´ÜÀÚ¿¡ ¿¬°áÇÏ´Â ÁÖº¯ ±â±âµéÀ» »ç¿ëÇÏ±â ½±°Ô ¸¸µç ¿ÜºÎ ´ÜÀÚ
	=> HDMI : ºñµğ¿À/¿Àµğ¿Àµî ¸ğµç ´ÜÀÚ¸¦ ÅëÇÕÇÏ¿© ÄÄÇ»ÅÍ ¹× ¿µ»ó±â±â¿¡¼­ Ãâ·ÂÀ» Ã³¸®ÇÏ´Â ±Ô¾à
		#. ¼­·Î ´Ù¸¥ Á¦Á¶»ç °£ÀÇ µ¥ÀÌÅÍ Àü¼ÛÀ» ¾ğÁ¦ ¾îµğ¼­³ª µ¿ÀÏÇÏ°Ô º¸ÀåÇØ ÁÖ´Â °³³äÀÌ ÀÎÅÍÆäÀÌ½º´Ù.
*/

/* --- < ÀÌ¸§°ø°£( Namespace ) > --- */

/*
< ÀÌ¸§ °ø°£ > : ³»ºÎ ½Äº°ÀÚµé¿¡ ¹üÀ§¸¦ ÁöÁ¤ÇÒ ¼ö ÀÖ´Â º°µµÀÇ °ø°£

< using Áö½ÃÀÚ > : ¿¹¸¦ µé¾î std::cout¿¡¼­ std::¿Í °°Àº µ¿ÀÏÇÑ Å¸ÀÌÇÎÀ» ¸Å¹ø ÇÏ´Â °ÍÀ» °£Ãß¸± ¼ö ÀÖ´Ù.
	=> using namespace std;
	#. Çì´õ ÆÄÀÏ¿¡¼­´Â »ç¿ëÇÏ¸é ¾ÊµÈ´Ù.
	#. µ¿ÀÏÇÑ Áö¿ª ½Äº°ÀÚ°¡ Á¸ÀçÇÏ¸é ±¸ºĞÀÌ µÇÁö ¾Ê¾Æ ÄÄÆÄÀÏ ¿¡·¯°¡ ¹ß»ıÇÑ´Ù.
*/
...
//	void Print() {}
//}
//// #. ÀÌ¸§ °ø°£¾È¿¡¼­ ÁöÁ¤ÇÑ ÀÌ¸§Àº ´Ù¸¥ ÀÌ¸§ °ø°£ÀÌ³ª Àü¿ª °ø°£¿¡¼­ ¸¸µç °°Àº ÀÌ¸§°ú Áßº¹µÇÁö ¾Ê´Â´Ù.
//
//int main()
//{
//	Game::Warrior warrior;
//// #. ÀÌ¸§ °ø°£¿¡ Á¢±ÙÇÏ±â À§ÇØ¼­´Â ( :: ) ¹üÀ§ ÇØ°á ¿¬»êÀÚ¸¦ »ç¿ëÇØ¾ß ÇÑ´Ù.
//
//	warrior.DoubleSlash();
//// #. warrior °°ÀÌ ÀÎ½ºÅÏ½ºÈ­µÈ °´Ã¼´Â ÀÌ¸§ °ø°£¿¡ ¼Ò¼ÓµÇÁö ¾Ê°ÔµÈ´Ù.
//
//	Game::Print();
//	GUI::Print();
//}
...
/*
< Á¤Àû ¸â¹ö ÇÔ¼ö > : ret-type (*) (param-list)
	#. ¿¹Á¦ : using fptr = int (*) (int)
	#. ¿¹Á¦ È£Ãâ : fptr(3);

< ºñ Á¤Àû ¸â¹ö ÇÔ¼ö > : ret-type (class-name::*) (param-list)
	#. ¿¹Á¦ : using fptr = int (MyClass::*) (int)
	#. ¿¹Á¦ È£Ãâ : (instance.*fptr)(3);
*/

//#include <iostream>		// < Title : ÀÏ¹İ ÇÔ¼ö Æ÷ÀÎÅÍ >
//
//// #. Àü¿ª ÇÔ¼öÀÇ Æ÷ÀÎÅÍ : ¹İÈ¯°ª + (Æ÷ÀÎÅÍ,ÀÌ¸§) + (¸Å°³º¯¼ö Á¾·ù)
//using FunctionPtr = int(*)(int);	// int (*f)(int x)
//// #. FunctionPtrÀº intÅ¸ÀÔÀ» ¹İÈ¯ÇÏ°í ¸Å°³ º¯¼ö¸¦ intÅ¸ÀÔÀ¸·Î ÇÑ °³ ¹Ş´Â Æ÷ÀÎÅÍÀÇ º°ÄªÀÌ´Ù.
//
...
//// #. S¶ó´Â ÀÌ¸§ÀÇ ÇÔ¼ö Æ÷ÀÎÅÍ¸¦ ¼±¾ğ ¹× SigmaÇÔ¼ö¸¦ ´ëÀÔÇÏ¿© ÃÊ±âÈ­
//
//	std::cout << S(SquareFunction, 1, 10) << std::endl;
//}

//#include <iostream>		// < Title : Á¤Àû ¸â¹ö ÇÔ¼öÀÇ Æ÷ÀÎÅÍ >
//
//class MyFunctions
//{
//public:
...
//	return x * x;
//	}
//// #. static¸â¹ö ÇÔ¼ö´Â class°¡ ¼ÒÀ¯ÇÏ°í ÀÖ´Ù.
//// #. ÀÌ Á¤Àû ¸â¹ö ÇÔ¼ö¸¦ Æ÷ÀÎÅÍ·Î ÁöÁ¤ÇÏ¿© »ç¿ëÇÒ ¿¹Á¤ÀÌ´Ù.
//};
//
//using FunctionPtr = int(*)(int);
//
//int Sigma(FunctionPtr f, int m, int n)	// Àü¿ª ÇÔ¼ö Sigma
//{
//	int sum = 0;
//	for (int i = m; i <= n; i++)
//	{
...
//// #1. ÇÔ¼ö Æ÷ÀÎÅÍ·Î Àü´ŞÇÒ ¸Å°³ º¯¼ö´Â class¼ÒÀ¯ÀÇ static¸â¹ö ÇÔ¼öÀÌ´Ù.
//// #2. ¶§¹®¿¡ ( :: ) ¹üÀ§ ÇØ°á ¿¬»êÀÚ¸¦ ÅëÇØ¼­ Å¬·¡½º¿¡ ¼ÓÇØÀÖ´Ù´Â °ÍÀ» ¾Ë·ÁÁÖ¾î¾ß ÇÑ´Ù.
//// #3. Àü¿ª ÇÔ¼öÀÇ Æ÷ÀÎÅÍ´Â Àü´ŞÇÏ´Â ÇÔ¼ö ÀÎÀÚ¸¦ ÀÚµ¿ÀûÀ¸·Î ÇÔ¼ö Æ÷ÀÎÅÍ Çü½ÄÀ¸·Î º¯È¯½ÃÄÑÁØ´Ù.
//// #4. ±×·¯³ª ¸â¹ö ÇÔ¼ö´Â ±×·¸Áö ¾Ê±â ¶§¹®¿¡ ¸â¹öÇÔ¼öÀÇ ÁÖ¼Ò( & )¸¦ ³Ñ°ÜÁÖ¾î¾ß ÇÑ´Ù.
//}

//#include <iostream>		// < Title : ºñ Á¤Àû ¸â¹ö ÇÔ¼öÀÇ Æ÷ÀÎÅÍ >
//
//class MyFunctions
//{
//public:
...
//		return x * x;
//	}
//// #. ºñ Á¤Àû ¸â¹öÇÔ¼ö´Â ÀÎ½ºÅÏ½º°¡ ¼ÒÀ¯ÇÏ°í ÀÖ´Ù.
//};
//
//using FunctionPtr = int(MyFunctions::*)(int);
//// #. Æ÷ÀÎÅÍ°¡ Å¬·¡½º ³»ºÎ¿¡ ÀÖ´Ù´Â °ÍÀ» ¾Ë·ÁÁà¾ß ÇÑ´Ù.
//
...
//	{
//		sum += (instance.*f)(i);
//		// ¸â¹ö ÇÔ¼ö È£ÃâÀº ÀÎ½ºÅÏ½º¿¡ (.)Á¡ ¿¬»êÀÚ¸¦ »ç¿ëÇÑ´Ù´Â °ÍÀ» ±â¾ïÇØ¶ó
//		// ¸â¹ö ÇÔ¼ö¸¦ °¡¸®Å°´Â Æ÷ÀÎÅÍ f¿¡ Á¢±ÙÇÏ±â À§ÇØ *f·Î ÀÔ·ÂÇÑ´Ù.
//	}
//	return sum;
//}
//
...
//// #. ºñ Á¤Àû ¸â¹ö ÇÔ¼ö´Â ÀÎ½ºÅÏ½º°¡ ¼ÒÀ¯ÇÏ°í ÀÖ±â ¶§¹®¿¡ ÀÎ½ºÅÏ½º¸¦ ÅëÇØ È£ÃâÇØ¾ß ÇÑ´Ù.
//}
...
/*
< ÅÛÇÃ¸´ >
	#. Å¸ÀÔÀ» ÀÏ¹İÈ­( Generalization )ÇÏ¿© ¾î¶°ÇÑ Å¸ÀÔµµ Ã³¸®ÇÒ ¼ö ÀÖµµ·Ï ¸¸µé°í
	#. ÇÁ·Î±×·¡¸Ó°¡ ¿øÇÏ´Â Å¸ÀÔÀ¸·Î Æ¯¼öÈ­( Specialization )¸¦ ÁøÇàÇÑ´Ù.

< ÅÛÇÃ¸´ ÇÔ¼ö > : ÇÔ¼ö¸¦ È£ÃâÇÒ¶§, ÄÄÆÄÀÏ·¯´Â T°¡ ¾î¶² Å¸ÀÔÀÏÁö ÀÚµ¿À¸·Î Ãß·ĞÇØ¼­ ÇÔ¼ö¸¦ ¸¸µé¾î ÁØ´Ù.
	=> template < typename T1, typename T2 ... >

< ÅÛÇÃ¸´ Å¬·¡½º > : Å¬·¡½º¸¦ È£ÃâÇÒ¶§, ÄÄÆÄÀÏ·¯´Â ¸â¹ö T°¡ ¾î¶² Å¸ÀÔÀÏÁö ÀÚµ¿À¸·Î Ãß·ĞÇØ¼­ Å¬·¡½º¸¦ ¸¸µé¾î ÁØ´Ù.
	=> template < class T1, class T2 ... >

< ÅÛÇÃ¸´ ÁÖÀÇ »çÇ× >
	#. ÀÚµ¿ÀÌ ¾Æ´Ï´Ù. ¸¹Àº Å¸ÀÔÀ¸·Î Æ¯¼öÈ­¸¦ ÇÏ¸é ±× ¸¸Å­ÀÇ ÄÚµå°¡ Ãß°¡µÈ´Ù.
	#. ÅÛÇÃ¸´ ¼±¾ğ°ú Á¤ÀÇ´Â °°Àº ÆÄÀÏ¿¡ Á¸ÀçÇØ¾ß ÇÑ´Ù.
*/

//#include <iostream>		// < Title : ÅÛÇÃ¸´ ÇÔ¼ö >
//
//// #1. ÇÔ¼ö Å¸ÀÔÀ» ÀÏ¹İÈ­½ÃÅ²´Ù.
//template <typename T>
//T Function(T x, T y)
//{	
//// #3. ÇÔ¼ö°¡ È£ÃâµÇ¾î ½ÇÇàÀÌ µÇ¸é ÀÌ ÇÔ¼ö ÄÚµå°¡ Æ¯¼öÈ­µÈ Å¸ÀÔÀ¸·Î ¹Ù²ï ¹öÀüÀÌ ¾Ï½ÃÀûÀ¸·Î º¹»çµÈ´Ù.
//	T sum;
//	sum = x + y;
//	return sum;
//// #4. ´Ù¾çÇÑ Å¸ÀÔÀ¸·Î ÇÔ¼ö¸¦ È£ÃâÇÏ¸é ÇÒ ¼ö·Ï ÄÚµåÀÇ ¿ë·®ÀÌ Ä¿Áø´Ù´Â ´ÜÁ¡ÀÌ ÀÖ´Ù.
//}
//
//int main()
//{	
//// #2. ÇÔ¼ö°¡ È£ÃâµÇ¸é¼­ Æ¯¼öÈ­°¡ ÁøÇàµÈ´Ù.
//// <> ºÎµîÈ£·Î Å¸ÀÔÀ» ¹­¾îÁÖÁö ¾Ê¾Æµµ ½ÇÇàµÈ´Ù. ±×·¯³ª ÄÚµå¸¦ ÀĞ±â ¾î·Á¿öÁüÀ¸·Î ÀÔ·ÂÇØÁÖ´Â °ÍÀÌ ÁÁ´Ù.
...
//#include <iostream>		// < Title : ÅÛÇÃ¸´ ÇÔ¼ö >
//
//// #1. ÅÛÇÃ¸´ ÇÔ¼ö¸¦ Á¤ÀÇ ÇÏ¿© ÁöÁ¤ÇÑ º¯¼öµéÀÇ Å¸ÀÔÀ» ÀÏ¹İÈ­ ½ÃÅ²´Ù.
//template<typename T>
...
//}
//
//// #2. ÅÛÇÃ¸´ ÇÔ¼ö¸¦ Á¤ÀÇ ÇÏ¿© ÁöÁ¤ÇÑ º¯¼öµéÀÇ Å¸ÀÔÀ» ÀÏ¹İÈ­ ½ÃÅ²´Ù.
//template<typename T>
...
//int main()
//{	
//// #2. Å¬·¡½ºÀÇ ¸â¹ö Å¸ÀÔÀ» 'Party'·Î ÁöÁ¤ÇÏ¿© Æ¯¼öÈ­ÇÏ°í °´Ã¼ hero·Î ¸¸µé¾î ÁØ´Ù.
//	LinkedList<Party> hero;
//	hero.Print();
//}

//#include <iostream>		// < Title : ¹®Á¦ »óÈ² >
//
//// MyClass.h¶ó°í °¡Á¤
//template <typename T>
//class MyClass {
...
//	void Function(T arg);
//};
//// #. ¸â¹ö º¯¼ö mValue´Â ¹®Á¦°¡ ¾ø´Ù ¹®Á¦´Â ¸â¹ö ÇÔ¼ö¿¡¼­ ¹ß»ıÇÑ´Ù.
//
//// MyClass.cpp¶ó°í °¡Á¤
//template <typename T>
//void MyClass<T>::Function(T arg) { }
//// #1. ÀÌ ¶óÀÎ±îÁö´Â ÅÛÇÃ¸´ÀÌ ÀÏ¹İÈ­¸¸ µÇ¾îÀÖ´Â »óÅÂ°í Æ¯¼öÈ­°¡ ÁøÇàµÇÁö ¾ÊÀº »óÈ²ÀÌ´Ù.
//
//// main.cpp¶ó°í °¡Á¤
//int main()
//{
//	MyClass<int> c1;
//	c1.Function(10);
//// #2. °´Ã¼°¡ ¸â¹ö ÇÔ¼ö¸¦ È£ÃâÇÒ ¶§ 'ÇÔ¼ö¸¦ Ã£À» ¼ö ¾ø´Ù'¶ó´Â ¸µÅ© ¿¡·¯¸¦ ¹ß»ı ½ÃÅ²´Ù.
////		=> c1ÀÌ ¸â¹ö ÇÔ¼ö¸¦ È£ÃâÇÏ¸é MyClass.h¿¡ ÀÖ´Â FunctionÀº (int arg)Å¸ÀÔÀ¸·Î Æ¯¼öÈ­°¡ ÁøÇàµÈ´Ù.
////		=> Function(int arg)ÇÔ¼ö´Â Á¤ÀÇ°¡ ÀÖ´Â .cpp·Î °¡¼­ ÀÚ±â ÀÚ½Å¿¡ ´ëÇÑ Á¤ÀÇ¸¦ Ã£À¸·Á ÇÑ´Ù.
////		=> ±×·±µ¥ MyClass.cpp¿¡ ÀÖ´Â FunctionÀº (T arg)ÀÎ ÀÏ¹İÈ­ ÇüÅÂ ±×´ë·ÎÀÎ »óÅÂÀÌ´Ù.
//// #3. ÀÌ¿Í °°Àº ¹®Á¦¸¦ ÇØ°áÇÏ·Á¸é .h¿¡ ÀÏ¹İÈ­ÇÑ ¸â¹ö ÇÔ¼ö¸¦ Á¤ÀÇ ÇØÁÖ¾î¾ß ÇÑ´Ù.
//}

/* --- < ¸í½ÃÀû »ı¼ºÀÚ( explicit constructor ) > --- */

/*
< ¸í½ÃÀû »ı¼ºÀÚ > : Å¬·¡½º °´Ã¼¸¦ ¸¸µé¶§ »ı¼ºÀÚ¸¦ ¸í½ÃÇÏµµ·Ï ÁöÁ¤ÇØ ³õ´Â Å°¿öµå
*/
...
//	int mInt;
//
//// #. °´Ã¼¸¦ ¸¸µé¶§ Å¬·¡½º Å¸ÀÔÀ» ¸íÈ®È÷ ¸í½ÃÇÏµµ·Ï °­¿äÇÏ´Â ÄÚµå
//	explicit MyClass(int val) : mInt{ val } {}
//};
//
//int main()
//{
//	MyClass c = 1;	// ¾Ï½ÃÀû »ı¼ºÀÚ : MyClass c = MyClass(1)°¡ explicitÀ¸·Î ÀÎÇØ ¢Èù´Ù.
//
//	MyClass c1 = MyClass(1);	// ¸í½ÃÀûÀ¸·Î Å¬·¡½º »ı¼ºÀÚ¸¦ ÅëÇØ º¹»ç ´ëÀÔÇÑ´Ù´Â °ÍÀ» ¾Ë·ÁÁÖ¾î¾ß ÇÑ´Ù.
//}